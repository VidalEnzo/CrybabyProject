...
public class TriggerSalon : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other) // Détecte la collision avec un gameObject
    {
        ...
        {
            anim.SetBool("OuvreSalon", false); // Modifie la valeur la valeur de la variable "goodObject" à false  
            anim.SetBool("FermeSalon", true); // Modifie la valeur la valeur de la variable "inSaloon" à true  
